var PokedexSearchPanel = Panels.Panel.extend({
  ...
  initialize: function () {
    ...
    buf +=
      '<h4>Pokemon Lucid <a href="https://pklucid.github.io/Pokemon-Lucid/src/download.html"target="_blank">Latest Version 1.2.11</a></h3>';
    buf +=
    ...
    buf +=
      ...
      (fragment === "" ? " cur" : "") +
      '" value="">Search</button></li>';
    buf +=
      '<li><button class="button' +
      (fragment === "pokemon/" ? " cur" : "") +
      '" value="pokemon/">Pok&eacute;mon</button></li>';
    buf +=
      '<li><button class="button' +
      (fragment === "encounters/" ? " cur" : "") +
      '" value="encounters/">Encounters</button></li>';
    buf +=
      '<li><button class="button nav-last' +
      (fragment === "moves/" ? " cur" : "") +
      '" value="moves/">Moves</button></li></ul>';
    buf +=
